...
function get_catalog_photos_title() {  
    $qry = mysql_query('SELECT distinct * from tg_catalogue where post_is_deleted = 0 and user_id = 2 and user_role_id = 2 and post_type = "image"');
    $data = array();
...
function get_catalog_photos_per_title() {  
  ...
  if ($data) {
    $post_id = $data->postId;
  $qry = mysql_query('SELECT distinct * from tg_catalogue where post_is_deleted = 0 and user_id = 2 and post_id = "'.$post_id.'" and user_role_id = 2 and post_type = "image"');
  $data = array();
  while($rows = mysql_fetch_array($qry))
  {
      $data[] = array(
