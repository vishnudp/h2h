...
@Component({
  selector: 'app-artists-catalogue-videos-content',
  templateUrl: './artists-catalogue-videos-content.component.html',
  styleUrls: ['./artists-catalogue-videos-content.component.css']
})
export class ArtistsCatalogueVideosContentComponent implements OnInit {
  @Input() showForm;
  ...
  getVideosTitleData() {
    this._commonRequestResponseService.post('artist-catalog-videos.php?action=get_catalog_videos_title', {})
      .subscribe((res) => {
  ...
  getVideosPerTitleData(postId) {
    ...
    this._commonRequestResponseService.post('artist-catalog-videos.php?action=get_catalog_videos_per_title', inputJson)
      .subscribe((res) => {
        console.log('api response--', res);
        if (res && res.length > 0) {
  ...
  deleteAttachmentPerPost() {
    ...
    this._commonRequestResponseService.post('artist-catalog-videos.php?action=delete_catalog_video_attachment', inputJson)
    .subscribe((res) => {
      if (res) {
