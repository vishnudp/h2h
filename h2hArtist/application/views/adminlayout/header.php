<header id="top_header">
  <div class="container">
    <div class="row">
      <div class="col-xs-6 col-sm-1"> <a href="<?php echo base_url(); ?>admin/dashboard" class="logo_main" title="H2H Entertainment Company"> <img src="<?php echo base_url(); ?>assets/images/logo.png" height="65" alt="logo" /> </a> </div>
